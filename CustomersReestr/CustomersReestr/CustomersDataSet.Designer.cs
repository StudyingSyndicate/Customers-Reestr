...
namespace CustomersReestr {
    ...
    public partial class CustomersDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CustomersRow AddCustomersRow(int Id, string name, System.DateTime birthday, System.DateTime RegDate) {
...
namespace CustomersReestr.CustomersDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([name] = @Original_na" +
                "me) AND ([birthday] = @Original_birthday) AND ([RegDate] = @Original_RegDate))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [name], [birthday], [RegDate]) VALUES (@Id, @nam" +
                "e, @birthday, @RegDate);\r\nSELECT Id, name, birthday, RegDate FROM [Table] WHERE " +
                "(Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [name] = @name, [birthday] = @birthday, [RegDate] = @RegDate WHERE (([Id] = @Original_Id) AND ([name] = @Original_name) AND ([birthday] = @Original_birthday) AND ([RegDate] = @Original_RegDate));
SELECT Id, name, birthday, RegDate FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CustomersReestr.Properties.Settings.Default.CustomersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, birthday, RegDate FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_name, System.DateTime Original_birthday, System.DateTime Original_RegDate) {
        ...
        public virtual int Insert(int Id, string name, System.DateTime birthday, System.DateTime RegDate) {
        ...
        public virtual int Update(int Id, string name, System.DateTime birthday, System.DateTime RegDate, int Original_Id, string Original_name, System.DateTime Original_birthday, System.DateTime Original_RegDate) {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((System.DateTime)(Original_RegDate));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, System.DateTime birthday, System.DateTime RegDate, int Original_Id, string Original_name, System.DateTime Original_birthday, System.DateTime Original_RegDate) {
            return this.Update(Original_Id, name, birthday, RegDate, Original_Id, Original_name, Original_birthday, Original_RegDate);
        }
    }
